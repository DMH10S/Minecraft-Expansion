...
public class RegistryHandler 
{
	...
	public static void initRegistries()
	{
		...
		farmer.getCareer(0).addTrade(1, new FarmerTradeHandler());
		...
		cleric.getCareer(2).addTrade(1, new ClericOneTradeHandler());
		cleric.getCareer(2).addTrade(2, new ClericTwoTradeHandler());
		...
		butcher.getCareer(4).addTrade(1, new ButcherTradeHandler());
	}
}
