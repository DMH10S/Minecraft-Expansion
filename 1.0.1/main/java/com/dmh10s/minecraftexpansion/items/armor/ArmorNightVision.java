...
public class ArmorNightVision extends ItemArmor implements IHasModel
{
	...
	{
		if(player.inventory.armorItemInSlot(3) != null && player.inventory.armorItemInSlot(3).getItem() == ModItems.NIGHT_VISION_VISOR)
		{
			player.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 20, 0, false, false));
		}
	}
