...
public class CokeFurnaceRecipes
{
	...
	private CokeFurnaceRecipes()
	{
        ...
        this.addCokeFurnace(Items.COAL, new ItemStack(ModItems.COKE, 1), 1.0f);
		...
		this.addCokeFurnace(ModItems.RAW_TURKEY_BREAST, new ItemStack(ModItems.COOKED_TURKEY_BREAST, 1), 1.0f);
		this.addCokeFurnace(ModItems.RAW_TURKEY_DRUMSTICK, new ItemStack(ModItems.COOKED_TURKEY_DRUMSTICK, 1), 1.0f);
	}
}
